...
function validateText(val, maxLen, label) {
...
function validateInt(val, min, max, label) {
  if (val === null || val === undefined) return null;
...
async function sunoFetch(url, kv) {
